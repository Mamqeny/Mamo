...
public class DataManager {
    ...
    public java.util.List<NoteInfo> getNotes() {
        return mNotes;
    }
    ...
    public java.util.List<com.mamo.notekeeper.CourseInfo> getCourses() {
        return mCourses;
    }
    ...
    public java.util.List<NoteInfo> getNotes(CourseInfo course) {
        java.util.ArrayList<NoteInfo> notes = new java.util.ArrayList<>();
    ...
    public void initializeExampleNotes() {
        final com.mamo.notekeeper.DataManager dm = getInstance();
    ...
    private CourseInfo initializeCourse1() {
        java.util.List<ModuleInfo> modules = new java.util.ArrayList<>();
